...
const CHECKS: { id: string; title: string }[] = [
  ...
  { id: "stop_status_checks", title: "چک‌کردن زمان آنلاین شدن، دیدن آخرین بازدید و دیدن عکس پروفایل رو متوقف کردم و اگه این بار تحریک شدم از تکنیک تب پناه کمک می‌گیرم" },
