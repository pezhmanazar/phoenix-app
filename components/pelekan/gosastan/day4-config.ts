//phoenix-app\components\pelekan\gosastan\day4-config.ts
import { AUDIO_KEYS } from "@/constants/media";
import type { DayConfig } from "../daily/types";

export const gosastanDay4Config: DayConfig = {
  dayCode: "gosastan_day4",
  stageCode: "gosastan",
  dayNumber: 4,
  titleFa: "روز چهارم گسستن",
  requiredTaskCodes: [
    "gosastan_day4_feelings_log",
    "gosastan_day4_morning_routine",
    "gosastan_day4_daily_commitment",
    "gosastan_day4_daily_meditation",
    "gosastan_day4_torch",
    "gosastan_day4_technique_1",
    "gosastan_day4_no_contact_check",
    "gosastan_day4_night_routine",
  ],
  tasks: [
    {
      code: "gosastan_day4_feelings_log",
    ...
    {
      code: "gosastan_day4_morning_routine",
      ...
      steps: [
        {
          ...
          sourceTaskCode: "gosastan_day4_feelings_log",
          variants: [
            {
              min: 1,
              max: 5,
              audioKey: AUDIO_KEYS.gosastan.day04.morningMeditationMood1To5,
              title: "مراقبه برای حال پایین",
            },
            {
              min: 6,
              max: 10,
              audioKey: AUDIO_KEYS.gosastan.day04.morningMeditationMood6To10,
        ...
        },
        {
          ...
          audioKey: AUDIO_KEYS.gosastan.day04.sunMeditation,
          required: true,
        },
        {
          key: "morning_stretch",
          ...
          audioKey: AUDIO_KEYS.gosastan.day04.morningStretchMeditation,
          required: true,
        },
        {
          key: "positive_note",
          ...
          checklist: [
            {
              id: "reminder_value_not_defined_by_them",
              label: "ارزش من با موندن یا رفتن یک نفر تعریف نمی‌شه.",
            },
            {
              id: "reminder_love_does_not_require_self_loss",
              label: "دوست داشتن نباید باعث بشه خودم رو فراموش کنم.",
            },
            {
              id: "reminder_rebuild_self_respect",
              label:
                "امروز می‌تونم با یک رفتار کوچیک، احترام به خودم رو تمرین کنم.",
            },
          ],
          placeholder:
            "مثلاً: امروز یادم می‌مونه که نبودن یک نفر، ارزش من رو کم نمی‌کنه.",
          multiline: true,
          required: true,
        },
    ...
    {
      code: "gosastan_day4_daily_commitment",
      titleFa: "تعهد روزانه",
      template: "commitment",
      required: true,
      completionRule: {
        ...
        requiredTypedConfirmations: [
          {
            key: "no_message",
            exactText: "امروز برای گرفتن توجهش به خودم پشت نمی‌کنم",
          },
          {
            key: "no_check_profile",
            exactText: "امروز ارزشم رو با دیدن و ندیدنِ اون نمی‌سنجم",
          },
        ],
      },
      meta: {
        ...
        commitments: [
          { id: "c1", text: "امروز برای جلب توجهش سراغ پیام یا تماس نمی‌رم" },
          {
            id: "c2",
            text: "امروز دنبال نشونه‌ای نمی‌گردم که حالم رو به اون گره بزنه",
          },
          {
            id: "c3",
            text: "امروز با چک کردن پیجش، خودم رو در معرض آسیب نمی‌ذارم",
          },
          { id: "c4", text: "امروز از دیگران نمی‌خوام بین من و اون پل بزنن" },
          {
            id: "c5",
            text: "امروز همه تکنیک‌های ضروری روز چهارم رو انجام می‌دم",
          },
          {
            id: "c6",
            text: "امروز یک کار مشخص برای احترام گذاشتن به خودم انجام می‌دم",
          },
          {
            id: "c7",
            text: "امروز یکی از کارهای کوچیکی که به نفع نظم یا آرامشمه رو بدون تعلل انجام می‌دم",
          },
          {
            id: "c8",
          ...
          {
            id: "c9",
            text: "امروز تا جای ممکن از محتواها و فضاهایی که من رو مقایسه‌ای و بی‌قرار می‌کنن فاصله می‌گیرم",
          },
        ],
      },
    },
    ...
    {
      code: "gosastan_day4_daily_meditation",
      ...
      meta: {
        audioKey: AUDIO_KEYS.gosastan.day04.specialMeditation,
        submitLabel: "ثبت مراقبه",
      },
    },
    {
      code: "gosastan_day4_feel_good_task",
      ...
      meta: {
        ...
        reminders: [
          "برای اینکه خواب امشبت به‌هم نریزه، از عصر به بعد چای، قهوه و نوشیدنی‌های انرژی‌زا مصرف نکن.",
          "شام رو کمی زودتر بخور تا بدنت قبل از خواب درگیر هضم سنگین نباشه.",
          "امشب برای گرفتن حس اطمینان یا توجه، سراغ پیج، پیام‌ها یا ردپاهاش نرو.",
          "اگه بی‌قرار شدی، به جای موندن در فکرها، یک کار آروم و کوتاه به نفع خودت انجام بده.",
          "نور اتاق رو کمتر کن تا هم چشم‌هات و هم ذهنت زودتر آماده استراحت بشن.",
          "یک روتین کوتاه مراقبتی مثل شستن صورت، مرتب کردن تخت یا دوش کوتاه می‌تونه به آروم‌تر شدنت کمک کنه.",
          "امشب وارد گفت‌وگوهایی نشو که باعث می‌شن دوباره خودت رو با گذشته یا با دیگران مقایسه کنی.",
        ],
    ...
    },
    {
      ...
      meta: {
        audioKey: AUDIO_KEYS.mashaal.lesson24,
        ...
        questions: [
          {
            ...
            type: "true_false",
            prompt:
              "مرز در رابطه شبیه دیوار نیست، بلکه خطیه که کمک می‌کنه هر کس خودش بمونه و رابطه هم امن بمونه.",
            options: [
              { id: "true", text: "صحیح" },
              { id: "false", text: "غلط" },
            ],
          ...
          },
          {
            ...
            type: "true_false",
            prompt:
              "مرزِ زمانی، یعنی فرد باید تمام وقتش رو به رابطه اختصاص بده تا صمیمیت بیشتر بشه.",
            options: [
              { id: "true", text: "صحیح" },
              { id: "false", text: "غلط" },
            ],
          ...
          },
          {
            ...
            type: "true_false",
            prompt:
              "در مرز احساسی هر فرد کاملاً مسئول حال خوب و بد طرف مقابله.",
            options: [
              { id: "true", text: "صحیح" },
              { id: "false", text: "غلط" },
            ],
          ...
          },
          {
            id: "q4",
            type: "true_false",
            prompt: "مرز سالم دشمن عشق نیست، بلکه نگهبان عشقه.",
            options: [
              { id: "true", text: "صحیح" },
              { id: "false", text: "غلط" },
            ],
          ...
          },
          {
            ...
            prompt: "کدوم گزینه جزو چهار بخش اصلی مرز سالم در رابطه‌ست؟",
            options: [
              { id: "a", text: "مرز زمانی" },
              { id: "b", text: "مرز مالی" },
              { id: "c", text: "مرز خانوادگی" },
              { id: "d", text: "مرز اجتماعی" },
            ],
            correctOptionId: "a",
          },
          {
            id: "q6",
            type: "multiple_choice",
            prompt: "مرز جسمی در رابطه بیشتر به چه معناست؟",
            options: [
              { id: "a", text: "طرف مقابل حق دارد درباره بدن فرد تصمیم بگیره" },
              {
                id: "b",
                text: "هر نوع نزدیکی در رابطه طبیعی و بدون نیاز به رضایته",
              },
              { id: "c", text: "بدن هر فرد متعلق به خودشه و رضایت اهمیت داره" },
              {
                id: "d",
                text: "در رابطه عاطفی دیگه نیازی به رعایت فاصله نیست",
              },
            ],
            correctOptionId: "c",
          },
          {
            ...
            type: "multiple_choice",
            prompt:
              "اگه کسی مدام بخواد بدونه طرف مقابل کجاست، با چه کسی حرف می‌زنه و چرا دیر جواب داده، این رفتار بیشتر نشونه چیه؟",
            options: [
              { id: "a", text: "عشق عمیق" },
              { id: "b", text: "کنترل" },
              { id: "c", text: "بلوغ عاطفی" },
              { id: "d", text: "صمیمیت سالم" },
            ],
            correctOptionId: "b",
          },
          {
            id: "q8",
            type: "multiple_choice",
            prompt: "قربانی‌گری در رابطه معمولاً چگونه خودش رو نشون می‌ده؟",
            options: [
              { id: "a", text: "احترام به تصمیم‌های طرف مقابل" },
              { id: "b", text: "بیان شفاف خواسته‌ها و نیازها" },
              {
                id: "c",
                text: "مدام گفتن اینکه «من همه‌چیز رو برای تو گذاشتم»",
              },
              { id: "d", text: "حفظ مرزهای شخصی" },
            ],
            correctOptionId: "c",
          },
          {
            id: "q9",
            type: "multiple_choice",
            prompt: "ارتباط مرزگذاری با عزت‌نفس چیه؟",
            options: [
              {
                id: "a",
                text: "کسی که عزت‌نفس بیشتری داره، راحت‌تر مرز می‌ذاره",
              },
              {
                id: "b",
                text: "عزت‌نفس بالا باعث می‌شه فرد هیچ نیازی به رابطه نداشته باشه",
              },
              { id: "c", text: "مرزگذاری نشونه خودخواهیه" },
              { id: "d", text: "عزت‌نفس ربطی به مرز نداره" },
            ],
            correctOptionId: "a",
          },
          {
            id: "q10",
            type: "multiple_choice",
            prompt: "کدوم جمله بهتر مفهوم رابطه سالم رو نشون می‌ده؟",
            options: [
              { id: "a", text: "برای حفظ رابطه باید همیشه از خود گذشت" },
              {
                id: "b",
                text: "رابطه سالم یعنی یکی تصمیم بگیره و دیگری تبعیت کنه",
              },
              {
                id: "c",
                text: "رابطه سالم یعنی صمیمیت همراه با احترام به زمان، احساس، بدن و تصمیم هر دو نفر",
              },
              { id: "d", text: "رابطه سالم یعنی هیچ‌وقت نه نگفتن" },
            ],
            correctOptionId: "c",
          },
        ],
    ...
    {
      code: "gosastan_day4_technique_1",
      titleFa: "شناسایی محرک‌های وابستگی",
      descriptionFa:
        "در این تمرین، محرک‌هایی رو که باعث فعال شدن میل به برگشت، تماس، چک کردن یا خیال‌پردازی درباره رابطه قبلی می‌شن شناسایی می‌کنی تا چرخه محرک، میل و واکنش رو واضح‌تر ببینی.",
      template: "routine_flow",
      required: true,
      completionRule: {
        type: "all_steps_completed",
      ...
      steps: [
        {
          key: "main_triggers_today",
          stepType: "text_input",
          title: "محرک‌های اصلی",
          instruction:
            "سه محرک اصلی امروزت رو بنویس؛ چیزهایی که باعث شدن میل به برگشت، تماس، چک کردن یا خیال‌پردازی در تو فعال بشه.",
          placeholder:
            "مثلاً: دیدن عکس، شنیدن آهنگ خاص، تنهایی شب، بوی یک عطر، اسمش، یک مکان آشنا یا دیدن استوری دیگران.",
          multiline: true,
          required: true,
        },
        {
          key: "trigger_reactions",
          stepType: "text_input",
          title: "واکنش‌ها",
          instruction:
            "مشخص کن هر محرک چه واکنشی در تو ایجاد می‌کنه. بیشتر روی حس، فکر یا آشفتگی‌ که بعدش فعال می‌شه تمرکز کن.",
          placeholder:
            "مثلاً: دلم می‌گیره، ذهنم می‌ره سمت خاطرات، مضطرب می‌شم، امید کاذب می‌گیرم، یا حس می‌کنم باید کاری بکنم.",
          multiline: true,
          required: true,
        },
        {
          key: "urge_after_trigger",
          stepType: "text_input",
          title: "میل بعد از محرک",
          instruction:
            "بنویس وقتی این محرک‌ها فعال می‌شن، معمولاً دلت می‌خواد چه کاری انجام بدی.",
          placeholder:
            "مثلاً: صفحش رو چک کنم، پیام بدم، عکس‌ها رو ببینم، آهنگ غمگین گوش بدم، خیال‌پردازی کنم یا از کسی دربارش بپرسم.",
          multiline: true,
          required: true,
        },
        {
          key: "harmful_reactions",
          stepType: "text_input",
          title: "واکنش آسیب‌زننده",
          instruction:
            "صادقانه بنویس کدوم واکنش‌ها بیشتر به تو آسیب می‌زنن و باعث می‌شن وابستگی دوباره تغذیه بشه.",
          placeholder:
            "مثلاً: چک کردن پیجش، نوشتن و فرستادن پیام، غرق شدن در خیال‌پردازی، گوش دادن مکرر به آهنگ‌های محرک یا مرور وسواس‌گونه خاطرات.",
          multiline: true,
          required: true,
        },
        {
          key: "healthy_replacement_response",
          stepType: "text_input",
          title: "پاسخ جایگزین",
          instruction:
            "برای هر محرک، یک پاسخ سالم جایگزین انتخاب کن؛ کاری که به‌جای واکنش آسیب‌زننده انجامش بدی.",
          placeholder:
            "مثلاً: اگه دلم خواست پیجش رو چک کنم، 3 دقیقه تنفس انجام می‌دم و گوشی رو کنار می‌ذارم. اگه دلم خواست پیام بدم، اول در یادداشت‌ها می‌نویسم ولی ارسالش نمی‌کنم. اگه یه آهنگ من رو بهم ریخت، قطعش می‌کنم و چند دقیقه راه می‌رم و بعدا سعی می‌کنم اون‌قدر اون آهنگ رو گوش بدم که برام عادی‌تر بشه.",
          multiline: true,
          required: true,
        },
      ],
    ...
    {
      code: "gosastan_day4_technique_2",
      titleFa: "تخلیه ذهن",
      descriptionFa:
    ...
    {
      code: "gosastan_day4_no_contact_check",
    ...
    {
      code: "gosastan_day4_night_routine",
      ...
      steps: [
          ...
          variants: [
            {
              min: 1,
              max: 5,
              audioKey: AUDIO_KEYS.gosastan.day04.nightMeditationMood1To5,
              title: "آرام‌سازی برای حال پایین",
            },
            {
              min: 6,
              max: 10,
              audioKey: AUDIO_KEYS.gosastan.day04.nightMeditationMood6To10,
        ...
        },
        {
          ...
          required: true,
          audioKey: AUDIO_KEYS.gosastan.day04.gratitude,
          textField: {
            key: "gratitude_notes",
        ...
        },
        {
          ...
          required: true,
          audioKey: AUDIO_KEYS.gosastan.day04.nightStretchMeditation,
        },
        {
          ...
          required: true,
          audioKey: AUDIO_KEYS.gosastan.day04.beforeSleepMeditation,
          textField: {
        ...
        },
        {
          ...
          required: true,
          audioKey: AUDIO_KEYS.gosastan.day04.sleepMeditation,
