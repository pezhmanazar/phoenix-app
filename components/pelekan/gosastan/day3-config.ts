//phoenix-app\components\pelekan\gosastan\day3-config.ts
import { AUDIO_KEYS } from "@/constants/media";
import type { DayConfig } from "../daily/types";

export const gosastanDay3Config: DayConfig = {
  dayCode: "gosastan_day3",
  stageCode: "gosastan",
  dayNumber: 3,
  titleFa: "روز سوم گسستن",
  requiredTaskCodes: [
    "gosastan_day3_feelings_log",
    "gosastan_day3_morning_routine",
    "gosastan_day3_daily_commitment",
    "gosastan_day3_daily_meditation",
    "gosastan_day3_torch",
    "gosastan_day3_technique_1",
    "gosastan_day3_no_contact_check",
    "gosastan_day3_night_routine",
  ],
  tasks: [
    {
      ...
      steps: [
        {
          ...
          sourceTaskCode: "gosastan_day3_feelings_log",
          variants: [
            {
              min: 1,
              max: 5,
              audioKey: AUDIO_KEYS.gosastan.day03.morningMeditationMood1To5,
              title: "مراقبه برای حال پایین",
            },
            {
              min: 6,
              max: 10,
              audioKey: AUDIO_KEYS.gosastan.day03.morningMeditationMood6To10,
        ...
        },
        {
          ...
          audioKey: AUDIO_KEYS.gosastan.day03.sunMeditation,
          required: true,
        },
        {
          key: "morning_stretch",
          ...
          audioKey: AUDIO_KEYS.gosastan.day03.morningStretchMeditation,
          required: true,
        },
        {
          key: "positive_note",
    ...
    },
    {
      ...
      meta: {
        audioKey: AUDIO_KEYS.gosastan.day03.specialMeditation,
    ...
    {
      code: "gosastan_day3_no_contact_check",
    ...
    },
    {
      ...
      steps: [
          ...
          variants: [
            {
              min: 1,
              max: 5,
              audioKey: AUDIO_KEYS.gosastan.day03.nightMeditationMood1To5,
              title: "آرام‌سازی برای حال پایین",
            },
            {
              min: 6,
              max: 10,
              audioKey: AUDIO_KEYS.gosastan.day03.nightMeditationMood6To10,
        ...
        },
        {
          ...
          required: true,
          audioKey: AUDIO_KEYS.gosastan.day03.gratitude,
          textField: {
            key: "gratitude_notes",
        ...
        },
        {
          ...
          required: true,
          audioKey: AUDIO_KEYS.gosastan.day03.nightStretchMeditation,
        },
        {
          ...
          required: true,
          audioKey: AUDIO_KEYS.gosastan.day03.beforeSleepMeditation,
          textField: {
        ...
        },
        {
          ...
          required: true,
          audioKey: AUDIO_KEYS.gosastan.day03.sleepMeditation,
