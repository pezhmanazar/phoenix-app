//phoenix-app\components\pelekan\gosastan\day1-config.ts
import { AUDIO_KEYS } from "@/constants/media";
import type { DayConfig } from "../daily/types";

export const gosastanDay1Config: DayConfig = {
  dayCode: "gosastan_day1",
  stageCode: "gosastan",
  dayNumber: 1,
  titleFa: "روز اول گسستن",
  requiredTaskCodes: [
    "gosastan_day1_feelings_log",
    "gosastan_day1_morning_routine",
    "gosastan_day1_daily_commitment",
    "gosastan_day1_daily_meditation",
    "gosastan_day1_torch",
    "gosastan_day1_technique_1",
    "gosastan_day1_no_contact_check",
    "gosastan_day1_night_routine",
  ],
  tasks: [
    {
      ...
      steps: [
        {
          ...
          sourceTaskCode: "gosastan_day1_feelings_log",
          variants: [
            {
              min: 1,
              max: 5,
              audioKey: AUDIO_KEYS.gosastan.day01.morningMeditationMood1To5,
              title: "مراقبه برای حال پایین",
            },
            {
              min: 6,
              max: 10,
              audioKey: AUDIO_KEYS.gosastan.day01.morningMeditationMood6To10,
        ...
        },
        {
          ...
          audioKey: AUDIO_KEYS.gosastan.day01.sunMeditation,
          required: true,
        },
        {
          key: "morning_stretch",
          ...
          audioKey: AUDIO_KEYS.gosastan.day01.morningStretchMeditation,
          required: true,
        },
        {
          key: "positive_note",
    ...
    },
    {
      ...
      meta: {
        audioKey: AUDIO_KEYS.gosastan.day01.specialMeditation,
    ...
    {
      code: "gosastan_day1_no_contact_check",
    ...
    },
    {
      ...
      steps: [
          ...
          variants: [
            {
              min: 1,
              max: 5,
              audioKey: AUDIO_KEYS.gosastan.day01.nightMeditationMood1To5,
              title: "آرام‌سازی برای حال پایین",
            },
            {
              min: 6,
              max: 10,
              audioKey: AUDIO_KEYS.gosastan.day01.nightMeditationMood6To10,
        ...
        },
        {
          ...
          required: true,
          audioKey: AUDIO_KEYS.gosastan.day01.gratitude,
          textField: {
            key: "gratitude_notes",
        ...
        },
        {
          ...
          required: true,
          audioKey: AUDIO_KEYS.gosastan.day01.nightStretchMeditation,
        },
        {
          ...
          required: true,
          audioKey: AUDIO_KEYS.gosastan.day01.beforeSleepMeditation,
          textField: {
        ...
        },
        {
          ...
          required: true,
          audioKey: AUDIO_KEYS.gosastan.day01.sleepMeditation,
