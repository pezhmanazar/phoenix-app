//phoenix-app\components\pelekan\gosastan\day2-config.ts
import { AUDIO_KEYS } from "@/constants/media";
import type { DayConfig } from "../daily/types";

export const gosastanDay2Config: DayConfig = {
  dayCode: "gosastan_day2",
  stageCode: "gosastan",
  dayNumber: 2,
  titleFa: "روز دوم گسستن",
  requiredTaskCodes: [
    "gosastan_day2_feelings_log",
    "gosastan_day2_morning_routine",
    "gosastan_day2_daily_commitment",
    "gosastan_day2_daily_meditation",
    "gosastan_day2_torch",
    "gosastan_day2_technique_1",
    "gosastan_day2_no_contact_check",
    "gosastan_day2_night_routine",
  ],
  tasks: [
    {
      ...
      steps: [
        {
          ...
          sourceTaskCode: "gosastan_day2_feelings_log",

          variants: [
            {
              min: 1,
              max: 5,
              audioKey: AUDIO_KEYS.gosastan.day02.morningMeditationMood1To5,
              title: "مراقبه برای حال پایین",
            },
            {
              min: 6,
              max: 10,
              audioKey: AUDIO_KEYS.gosastan.day02.morningMeditationMood6To10,
        ...
        },
        {
          ...
          audioKey: AUDIO_KEYS.gosastan.day02.sunMeditation,
          required: true,
        },
        {
          key: "morning_stretch",
          ...
          audioKey: AUDIO_KEYS.gosastan.day02.morningStretchMeditation,
          required: true,
        },
        {
          key: "positive_note",
    ...
    },
    {
      ...
      meta: {
        audioKey: AUDIO_KEYS.gosastan.day02.specialMeditation,
    ...
    },
    {
      ...
      steps: [
          ...
          variants: [
            {
              min: 1,
              max: 5,
              audioKey: AUDIO_KEYS.gosastan.day02.nightMeditationMood1To5,
              title: "آرام‌سازی برای حال پایین",
            },
            {
              min: 6,
              max: 10,
              audioKey: AUDIO_KEYS.gosastan.day02.nightMeditationMood6To10,
        ...
        },
        {
          ...
          required: true,
          audioKey: AUDIO_KEYS.gosastan.day02.gratitude,
          textField: {
            key: "gratitude_notes",
        ...
        },
        {
          ...
          required: true,
          audioKey: AUDIO_KEYS.gosastan.day02.nightStretchMeditation,
        },
        {
          ...
          required: true,
          audioKey: AUDIO_KEYS.gosastan.day02.beforeSleepMeditation,
          textField: {
        ...
        },
        {
          ...
          required: true,
          audioKey: AUDIO_KEYS.gosastan.day02.sleepMeditation,
