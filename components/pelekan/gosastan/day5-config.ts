//phoenix-app\components\pelekan\gosastan\day5-config.ts
import { AUDIO_KEYS } from "@/constants/media";
import type { DayConfig } from "../daily/types";

export const gosastanDay5Config: DayConfig = {
  dayCode: "gosastan_day5",
  stageCode: "gosastan",
  dayNumber: 5,
  titleFa: "روز پنجم گسستن",
  requiredTaskCodes: [
    "gosastan_day5_feelings_log",
    "gosastan_day5_morning_routine",
    "gosastan_day5_daily_commitment",
    "gosastan_day5_daily_meditation",
    "gosastan_day5_torch",
    "gosastan_day5_technique_1",
    "gosastan_day5_no_contact_check",
    "gosastan_day5_night_routine",
  ],
  tasks: [
    {
    ...
    {
      code: "gosastan_day5_morning_routine",
      ...
      steps: [
        {
          ...
          sourceTaskCode: "gosastan_day5_feelings_log",
          variants: [
            {
              min: 1,
              max: 5,
              audioKey: AUDIO_KEYS.gosastan.day05.morningMeditationMood1To5,
              title: "مراقبه برای حال پایین",
            },
            {
              min: 6,
              max: 10,
              audioKey: AUDIO_KEYS.gosastan.day05.morningMeditationMood6To10,
        ...
        },
        {
          ...
          audioKey: AUDIO_KEYS.gosastan.day05.sunMeditation,
          required: true,
        },
        {
          key: "morning_stretch",
          ...
          audioKey: AUDIO_KEYS.gosastan.day05.morningStretchMeditation,
          required: true,
        },
        {
          key: "positive_note",
    ...
    {
      code: "gosastan_day5_daily_commitment",
      titleFa: "تعهد روزانه",
      template: "commitment",
      required: true,
      completionRule: {
    ...
    {
      code: "gosastan_day5_daily_meditation",
      ...
      meta: {
        audioKey: AUDIO_KEYS.gosastan.day05.specialMeditation,
        submitLabel: "ثبت مراقبه",
      },
    },
    {
      code: "gosastan_day5_feel_good_task",
    ...
    {
      code: "gosastan_day5_technique_1",
    ...
    {
      code: "gosastan_day5_technique_2",
      titleFa: "تخلیه ذهن",
      descriptionFa:
    ...
    },
    {
      ...
      steps: [
          ...
          variants: [
            {
              min: 1,
              max: 5,
              audioKey: AUDIO_KEYS.gosastan.day05.nightMeditationMood1To5,
              title: "آرام‌سازی برای حال پایین",
            },
            {
              min: 6,
              max: 10,
              audioKey: AUDIO_KEYS.gosastan.day05.nightMeditationMood6To10,
        ...
        },
        {
          ...
          required: true,
          audioKey: AUDIO_KEYS.gosastan.day05.gratitude,
          textField: {
            key: "gratitude_notes",
        ...
        },
        {
          ...
          required: true,
          audioKey: AUDIO_KEYS.gosastan.day05.nightStretchMeditation,
        },
        {
          ...
          required: true,
          audioKey: AUDIO_KEYS.gosastan.day05.beforeSleepMeditation,
          textField: {
        ...
        },
        {
          ...
          required: true,
          audioKey: AUDIO_KEYS.gosastan.day05.sleepMeditation,
