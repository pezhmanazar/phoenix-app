//phoenix-app\components\pelekan\sookhtan\day5-config.ts
import { AUDIO_KEYS } from "@/constants/media";
import type { DayConfig } from "../daily/types";

export const sookhtanDay5Config: DayConfig = {
  dayCode: "sookhtan_day5",
  stageCode: "sookhtan",
  dayNumber: 5,
  titleFa: "روز پنجم سوختن",
  requiredTaskCodes: [
    "sookhtan_day5_feelings_log",
    "sookhtan_day5_morning_routine",
    "sookhtan_day5_daily_commitment",
    "sookhtan_day5_daily_meditation",
    "sookhtan_day5_torch",
    "sookhtan_day5_technique_1",
    "sookhtan_day5_no_contact_check",
    "sookhtan_day5_night_routine",
  ],
  tasks: [
    {
      code: "sookhtan_day5_feelings_log",
    ...
    {
      code: "sookhtan_day5_morning_routine",
      ...
      steps: [
        {
          ...
          sourceTaskCode: "sookhtan_day5_feelings_log",
          variants: [
            {
              min: 1,
              max: 5,
              audioKey: AUDIO_KEYS.sookhtan.day05.morningMeditationMood1To5,
              title: "مراقبه برای حال پایین",
            },
            {
              min: 6,
              max: 10,
              audioKey: AUDIO_KEYS.sookhtan.day05.morningMeditationMood6To10,
        ...
        },
        {
          ...
          audioKey: AUDIO_KEYS.sookhtan.day05.sunMeditation,
          required: true,
        },
        {
          key: "morning_stretch",
          ...
          audioKey: AUDIO_KEYS.sookhtan.day05.morningStretchMeditation,
          required: true,
        },
        {
          key: "positive_note",
    ...
    {
      code: "sookhtan_day5_daily_commitment",
      titleFa: "تعهد روزانه",
      template: "commitment",
      required: true,
      completionRule: {
    ...
    {
      code: "sookhtan_day5_daily_meditation",
      ...
      meta: {
        audioKey: AUDIO_KEYS.sookhtan.day05.specialMeditation,
        submitLabel: "ثبت مراقبه",
      },
    },
    {
      code: "sookhtan_day5_feel_good_task",
    ...
    {
      code: "sookhtan_day5_technique_1",
    ...
    {
      code: "sookhtan_day5_technique_2",
      titleFa: "تخلیه ذهن",
      descriptionFa:
    ...
    {
      code: "sookhtan_day5_no_contact_check",
    ...
    {
      code: "sookhtan_day5_night_routine",
      ...
      steps: [
          ...
          variants: [
            {
              min: 1,
              max: 5,
              audioKey: AUDIO_KEYS.sookhtan.day05.nightMeditationMood1To5,
              title: "آرام‌سازی برای حال پایین",
            },
            {
              min: 6,
              max: 10,
              audioKey: AUDIO_KEYS.sookhtan.day05.nightMeditationMood6To10,
        ...
        },
        {
          ...
          required: true,
          audioKey: AUDIO_KEYS.sookhtan.day05.gratitude,
          textField: {
            key: "gratitude_notes",
        ...
        },
        {
          ...
          required: true,
          audioKey: AUDIO_KEYS.sookhtan.day05.nightStretchMeditation,
        },
        {
          ...
          required: true,
          audioKey: AUDIO_KEYS.sookhtan.day05.beforeSleepMeditation,
          textField: {
        ...
        },
        {
          ...
          required: true,
          audioKey: AUDIO_KEYS.sookhtan.day05.sleepMeditation,
