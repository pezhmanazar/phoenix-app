//phoenix-app\components\pelekan\sookhtan\Day12-config.ts
import { AUDIO_KEYS } from "@/constants/media";
import type { DayConfig } from "../daily/types";

export const sookhtanDay12Config: DayConfig = {
  dayCode: "sookhtan_day12",
  stageCode: "sookhtan",
  dayNumber: 12,
  titleFa: "روز دوازدهم سوختن",
  requiredTaskCodes: [
    "sookhtan_day12_feelings_log",
    "sookhtan_day12_morning_routine",
    "sookhtan_day12_daily_commitment",
    "sookhtan_day12_daily_meditation",
    "sookhtan_day12_torch",
    "sookhtan_day12_technique_1",
    "sookhtan_day12_no_contact_check",
    "sookhtan_day12_night_routine",
  ],
  tasks: [
    {
      code: "sookhtan_day12_feelings_log",
    ...
    {
      code: "sookhtan_day12_morning_routine",
      ...
      steps: [
        {
          ...
          sourceTaskCode: "sookhtan_day12_feelings_log",
          variants: [
            {
              min: 1,
              max: 5,
              audioKey: AUDIO_KEYS.sookhtan.day12.morningMeditationMood1To5,
              title: "مراقبه برای حال پایین",
            },
            {
              min: 6,
              max: 10,
              audioKey: AUDIO_KEYS.sookhtan.day12.morningMeditationMood6To10,
        ...
        },
        {
          ...
          audioKey: AUDIO_KEYS.sookhtan.day12.sunMeditation,
          required: true,
        },
        {
          key: "morning_stretch",
          ...
          audioKey: AUDIO_KEYS.sookhtan.day12.morningStretchMeditation,
          required: true,
        },
        {
          key: "positive_note",
    ...
    {
      code: "sookhtan_day12_daily_commitment",
      titleFa: "تعهد روزانه",
      template: "commitment",
      required: true,
      completionRule: {
    ...
    {
      code: "sookhtan_day12_safe_place",
      titleFa: "پناهگاه",
      template: "reminder",
      required: false,
    ...
    {
      code: "sookhtan_day12_daily_meditation",
      ...
      meta: {
        audioKey: AUDIO_KEYS.sookhtan.day12.specialMeditation,
        submitLabel: "ثبت مراقبه",
      },
    },
    {
      code: "sookhtan_day12_feel_good_task",
    ...
    {
      code: "sookhtan_day12_technique_1",
    ...
    {
      code: "sookhtan_day12_technique_2",
      titleFa: "تخلیه ذهن",
      descriptionFa:
    ...
    {
      code: "sookhtan_day12_no_contact_check",
    ...
    {
      code: "sookhtan_day12_night_routine",
      ...
      steps: [
          ...
          variants: [
            {
              min: 1,
              max: 5,
              audioKey: AUDIO_KEYS.sookhtan.day12.nightMeditationMood1To5,
              title: "آرام‌سازی برای حال پایین",
            },
            {
              min: 6,
              max: 10,
              audioKey: AUDIO_KEYS.sookhtan.day12.nightMeditationMood6To10,
        ...
        },
        {
          ...
          required: true,
          audioKey: AUDIO_KEYS.sookhtan.day12.gratitude,
          textField: {
            key: "gratitude_notes",
        ...
        },
        {
          ...
          required: true,
          audioKey: AUDIO_KEYS.sookhtan.day12.nightStretchMeditation,
        },
        {
          ...
          required: true,
          audioKey: AUDIO_KEYS.sookhtan.day12.beforeSleepMeditation,
          textField: {
        ...
        },
        {
          ...
          required: true,
          audioKey: AUDIO_KEYS.sookhtan.day12.sleepMeditation,
