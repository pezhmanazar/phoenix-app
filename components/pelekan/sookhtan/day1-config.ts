//phoenix-app\components\pelekan\sookhtan\day1-config.ts
import { AUDIO_KEYS } from "@/constants/media";
import type { DayConfig } from "../daily/types";

export const sookhtanDay1Config: DayConfig = {
  dayCode: "sookhtan_day1",
  stageCode: "sookhtan",
  dayNumber: 1,
  titleFa: "روز اول سوختن",
  requiredTaskCodes: [
    "sookhtan_day1_feelings_log",
    "sookhtan_day1_morning_routine",
    "sookhtan_day1_daily_commitment",
    "sookhtan_day1_daily_meditation",
    "sookhtan_day1_torch",
    "sookhtan_day1_technique_1",
    "sookhtan_day1_no_contact_check",
    "sookhtan_day1_night_routine",
  ],
  tasks: [
    {
      code: "sookhtan_day1_feelings_log",
    ...
    {
      code: "sookhtan_day1_morning_routine",
      ...
      steps: [
        {
          ...
          sourceTaskCode: "sookhtan_day1_feelings_log",
          variants: [
            {
              min: 1,
              max: 5,
              audioKey: AUDIO_KEYS.sookhtan.day01.morningMeditationMood1To5,
              title: "مراقبه برای حال پایین",
            },
            {
              min: 6,
              max: 10,
              audioKey: AUDIO_KEYS.sookhtan.day01.morningMeditationMood6To10,
        ...
        },
        {
          ...
          audioKey: AUDIO_KEYS.sookhtan.day01.sunMeditation,
          required: true,
        },
        {
          key: "morning_stretch",
          ...
          audioKey: AUDIO_KEYS.sookhtan.day01.morningStretchMeditation,
          required: true,
        },
        {
          key: "positive_note",
          ...
          instruction:
            "اول چند یادآوری کوچیک رو تیک بزن، بعد جمله حمایتی امروزت رو بنویس.",
          checklist: [
            {
              id: "reminder_continue",
              label: "لازم نیست امروز کامل باشم، فقط کافیه ادامه بدم.",
            },
            {
              id: "reminder_not_weak",
              label: "احساس سخت امروز به این معنی نیست که من ضعیفم.",
            },
            {
              id: "reminder_small_step",
              label: "من می‌تونم امروز فقط یک قدم کوچیک اما واقعی بردارم.",
            },
          ],
          placeholder:
            "مثلاً: امروز با خودم مهربون‌تر می‌مونم و فقط قدم بعدی رو برمی‌دارم.",
          multiline: true,
          required: true,
        },
        {
    ...
    {
      code: "sookhtan_day1_daily_commitment",
      titleFa: "تعهد روزانه",
      template: "commitment",
      required: true,
      completionRule: {
        ...
        requiredTypedConfirmations: [
          {
            key: "no_message",
            exactText: "امروز بهش پیام نمی‌دم",
          },
          {
            key: "no_check_profile",
            exactText: "امروز پیجش رو چک نمی‌کنم",
          },
        ],
      },
      meta: {
        ...
        commitments: [
          { id: "c1", text: "امروز بهش پیام نمی‌دهم" },
          { id: "c2", text: "امروز سراغش رو نمی‌گیرم" },
          { id: "c3", text: "امروز صفحه‌اش رو چک نمی‌کنم" },
          { id: "c4", text: "امروز از دیگران دربارش سؤال نمی‌کنم" },
          {
            id: "c5",
            text: "امروز همه تکنیک‌های ضروری روز اول رو انجام می‌دم",
          },
          {
            id: "c6",
            text: "امروز یک کار کوچیک عقب‌افتاده رو انجام می‌دم",
          },
          {
            id: "c7",
    ...
    {
      code: "sookhtan_day1_daily_meditation",
      ...
      meta: {
        audioKey: AUDIO_KEYS.sookhtan.day01.specialMeditation,
        submitLabel: "ثبت مراقبه",
      },
    },
    {
      code: "sookhtan_day1_feel_good_task",
      ...
      meta: {
        ...
        reminders: [
          "برای اینکه امشب خواب بهتری داشته باشی، از ساعت پنج عصر مصرف چای، قهوه و نوشابه انرژی‌زا رو متوقف کن.",
          "غذای شب رو حداقل دو ساعت قبل از خواب بخور.",
          "امشب تا جای ممکن سراغ چک کردن پروفایل، پیام‌ها یا خاطره‌بازی نرو.",
          "اگه ذهنت شلوغ شد، به جای فکر کردن، یک کار آروم و کوتاه انجام بده.",
          "نور محیط رو از شب به بعد کمتر کن تا بدنت برای خواب آماده بشه.",
          "اگه لازم شد قبل از خواب یک دوش کوتاه یا شست‌وشوی صورت انجام بده.",
          " قبل از خواب وارد گفت‌وگوهای احساسی با کسی نشو.",
        ],
        minTimerSeconds: 300,
    ...
    {
      code: "sookhtan_day1_torch",
      titleFa: "مشعل روز اول",
      template: "quiz_audio",
      required: true,
      completionRule: {
        type: "quiz_pass",
      ...
      meta: {
        audioKey: AUDIO_KEYS.mashaal.lesson21,
        submitLabel: "ثبت درس امروز",
        questions: [
          {
            id: "q1",
            type: "true_false",
            prompt: "بیشتر رابطه‌ها فقط به خاطر یک دلیل ساده تموم نمیشن.",
            options: [
              { id: "true", text: "صحیح" },
              { id: "false", text: "غلط" },
            ],
          ...
          },
          {
            ...
            type: "true_false",
            prompt:
              "اگه دو نفر همدیگه رو خیلی دوست داشته باشند، برای ادامه رابطه هیچ چیز دیگه‌ای لازم نیست.",
            options: [
              { id: "true", text: "صحیح" },
              { id: "false", text: "غلط" },
            ],
          ...
          },
          {
            ...
            type: "true_false",
            prompt:
              "وقتی یک نفر خیلی به توجه و اطمینان نیاز داره و نفر دیگه از نزدیکی زیاد فرار می‌کنه، رابطه ممکنه فرسوده بشه.",
            options: [
              { id: "true", text: "صحیح" },
              { id: "false", text: "غلط" },
            ],
          ...
          },
          {
            ...
            type: "true_false",
            prompt:
              "اگه برای خیانت یک دلیل روانی پیدا کنیم، یعنی اون رفتار قابل قبوله.",
            options: [
              { id: "true", text: "صحیح" },
              { id: "false", text: "غلط" },
            ],
          ...
          },
          {
            ...
            prompt:
              "چرا تفاوت در ارزش‌ها و هدف‌های زندگی میتونه رابطه رو خراب کنه؟",
            options: [
              { id: "a", text: "چون آدم‌های متفاوت نمی‌تونند جذب هم بشن" },
              {
                id: "b",
                text: "چون برای ساختن آینده مشترک باید در چیزهای مهم هم‌جهت بود",
              },
              { id: "c", text: "چون تفاوت‌ها همیشه باعث دعوای شدید میشن" },
              { id: "d", text: "چون یکی از دو نفر حتماً آدم بدیه" },
            ],
            correctOptionId: "b",
          },
          {
            ...
            type: "multiple_choice",
            prompt:
              "توو رابطه‌ای که یکی مضطربه و اون یکی از صمیمیت می‌ترسه، معمولاً چه اتفاقی می‌افته؟",
            options: [
              { id: "a", text: "هر دوشون آروم‌تر میشن" },
              { id: "b", text: "هرچی یکی نزدیک‌تر میشه اون یکی دورتر میشه" },
              { id: "c", text: "سریع ازدواج می‌کنند تا مشکل حل بشه" },
              { id: "d", text: "هیچ فشاری به رابطه وارد نمیشه" },
            ],
            correctOptionId: "b",
          },
          {
            id: "q7",
            type: "multiple_choice",
            prompt: "مشکل ارتباطی حل‌نشده یعنی چی؟",
            options: [
              { id: "a", text: "هر از گاهی بحث کردن" },
              { id: "b", text: "اختلاف نظر داشتن" },
              {
                id: "c",
                text: "ناتوانی در درست حرف زدن، شنیدن و حل کردن دلخوری‌ها",
              },
              { id: "d", text: "متفاوت بودن شخصیت‌ها" },
            ],
            correctOptionId: "c",
          },
          {
            id: "q8",
            type: "multiple_choice",
            prompt: "چرا خیانت فقط یک اتفاق ساده نیست؟",
            options: [
              { id: "a", text: "چون اعتماد رابطه رو از بین می‌بره" },
              { id: "b", text: "چون همیشه به خاطر پول اتفاق می‌افته" },
              { id: "c", text: "چون فقط باعث ناراحتی کوتاه‌مدت میشه" },
              { id: "d", text: "چون همه رابطه‌ها بعدش ادامه پیدا می‌کنند" },
            ],
            correctOptionId: "a",
          },
          {
            id: "q9",
            type: "multiple_choice",
            prompt: "بعد از جدایی، چرا همیشه نمیشه گفت فقط یک نفر مقصر بوده؟",
            options: [
              {
                id: "a",
                text: "چون معمولاً چند عامل با هم باعث پایان رابطه میشن",
              },
              { id: "b", text: "چون هیچ‌کس اشتباه نمی‌کنه" },
              { id: "c", text: "چون باید همیشه خودمون رو هم مقصر بدونیم" },
              {
                id: "d",
                text: "چون عشق خودش تصمیم می‌گیره رابطه تموم بشه یا نه",
              },
            ],
            correctOptionId: "a",
          },
          {
            ...
            type: "multiple_choice",
            prompt:
              "برای پایدار موندن یک رابطه علاوه بر عشق چه چیزهای دیگه‌ای هم لازمه؟",
            options: [
              { id: "a", text: "شباهت کامل در همه چیز" },
              { id: "b", text: "فضا دادن، صداقت و توان حل مشکلات" },
              { id: "c", text: "کنترل کامل طرف مقابل" },
              { id: "d", text: "بی‌تفاوت بودن به مشکلات" },
            ],
            correctOptionId: "b",
          },
        ],
    ...
    {
      code: "sookhtan_day1_technique_1",
      titleFa: "مرور یک خاطره منفی",
      descriptionFa:
        "در این تمرین، یک خاطره آزاردهنده از رابطه رو مرحله‌به‌مرحله مرور می‌کنی تا واقعیت رابطه رو واضح‌تر ببینی، نه اون تصویری که دلت هنوز می‌خواد نگه داره.",
      template: "routine_flow",
      required: true,
      completionRule: {
        type: "all_steps_completed",
      ...
      steps: [
        {
          ...
          title: "انتخاب خاطره",
          instruction:
            "فقط یک خاطره منفی یا آزاردهنده از رابطه رو انتخاب کن؛ خاطره‌ای که هنوز ذهنت رو درگیر می‌کنه.",
          placeholder:
            "مثلاً: روزی که نادیده گرفته شدم، تحقیر شدم، دروغ شنیدم یا احساس ناامنی کردم.",
          multiline: true,
          required: true,
        },
        {
          ...
          title: "شرح اتفاق",
          instruction:
            "حالا خیلی ساده و روشن بنویس دقیقاً چه اتفاقی افتاد. نه توجیهش کن و نه کم‌اهمیت نشونش بده.",
          placeholder:
            "ماجرا رو همون‌طور که بود بنویس؛ کوتاه یا کامل فرقی نمی‌کنه، ولی صادقانه بنویسش.",
          multiline: true,
          required: true,
        },
        {
          key: "feeling_then",
          stepType: "text_input",
          title: "احساس تو در اون لحظه",
          instruction:
            "وقتی اون اتفاق افتاد، همون لحظه چه احساسی رو تجربه کردی؟ فقط احساس واقعیت رو بنویس و بنویس چرا این احساس رو داشتی؟.",
          placeholder:
            "مثلاً: غم، خشم، ترس، شرم، بی‌ارزشی، تنهایی، گیجی، ناامنی...",
          multiline: true,
          required: true,
        },
        {
          ...
          stepType: "text_input",
          title: "حقیقتی که این خاطره نشون می‌ده",
          instruction:
            "این خاطره چه حقیقت مهمی درباره اون رابطه به تو نشون می‌ده؟ این بخش خیلی مهمه؛ چون کمک می‌کنه رابطه رو واقعی‌تر ببینی.",
          placeholder:
            "مثلاً: این رابطه همیشه امن، محترمانه، قابل اعتماد یا متقابل نبوده.",
          multiline: true,
          required: true,
        },
      ],
    ...
    {
      code: "sookhtan_day1_technique_2",
      titleFa: "تخلیه ذهن",
      descriptionFa:
    ...
    {
      code: "sookhtan_day1_no_contact_check",
        ...
        steps: [
          {
            key: "status",
            label: "وضعیت امروز",
            hint: "مشخص کن امروز ارتباطت با اکست چطور بوده",
          },
          {
            key: "questions",
            label: "بررسی دقیق‌تر",
          ...
          },
          {
            ...
            hint: "این بخش کمک می‌کنه دقیق‌تر حریمت رو حفظ کنی",
          },
          {
            key: "final",
            label: "ثبت نهایی",
    ...
    {
      code: "sookhtan_day1_night_routine",
      ...
      steps: [
          ...
          variants: [
            {
              min: 1,
              max: 5,
              audioKey: AUDIO_KEYS.sookhtan.day01.nightMeditationMood1To5,
              title: "آرام‌سازی برای حال پایین",
            },
            {
              min: 6,
              max: 10,
              audioKey: AUDIO_KEYS.sookhtan.day01.nightMeditationMood6To10,
        ...
        },
        {
          ...
          scoreField: {
            key: "night_day_score",
            label:
              "به کل روزت از ۱ تا ۲۰ چه نمره‌ای می‌دی؟ نمره واقع‌بینانه بده نه بدبینانه، نه خوشبینانه!",
            min: 1,
            max: 20,
          },
        },
        ...
        },
        {
          ...
          required: true,
          audioKey: AUDIO_KEYS.sookhtan.day01.gratitude,
          textField: {
            key: "gratitude_notes",
        ...
        },
        {
          ...
          required: true,
          audioKey: AUDIO_KEYS.sookhtan.day01.nightStretchMeditation,
        },
        {
          ...
          required: true,
          audioKey: AUDIO_KEYS.sookhtan.day01.beforeSleepMeditation,
          textField: {
        ...
        },
        {
          ...
          required: true,
          audioKey: AUDIO_KEYS.sookhtan.day01.sleepMeditation,
